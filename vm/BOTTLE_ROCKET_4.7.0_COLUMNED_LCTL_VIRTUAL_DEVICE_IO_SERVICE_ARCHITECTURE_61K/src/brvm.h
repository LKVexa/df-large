...
enum br_device_id{BR_DEVICE_CONSOLE=1u,BR_DEVICE_BLOCK,BR_DEVICE_MONOTONIC,BR_DEVICE_ENTROPY,BR_DEVICE_CLOCK,BR_DEVICE_MAILBOX,BR_DEVICE_DIAGNOSTIC,BR_DEVICE_NETWORK,BR_DEVICE_WALL_CLOCK};enum br_device_flag{BR_DEVICE_DETERMINISTIC=1u,BR_DEVICE_NONDETERMINISTIC=2u,BR_DEVICE_OPTIONAL=4u};
