# BR-420-11 — Round-trip tools

Decision: **OPERATIONAL** in the 4.2.0 host-reference native-semantic-authority scope.

Atomic requirements: 5. Fresh semantic, operational, sanitizer, deterministic-rebuild, size, provenance and independent-verifier evidence passes.
