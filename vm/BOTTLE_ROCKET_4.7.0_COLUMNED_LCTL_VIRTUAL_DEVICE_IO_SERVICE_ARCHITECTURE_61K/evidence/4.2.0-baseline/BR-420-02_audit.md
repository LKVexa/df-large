# BR-420-02 — Native opcode semantics

Decision: **OPERATIONAL** in the 4.2.0 host-reference native-semantic-authority scope.

Atomic requirements: 10. Fresh semantic, operational, sanitizer, deterministic-rebuild, size, provenance and independent-verifier evidence passes.
